...
public class MovieListTest {
	...
	@Before @Test public void setUpMovieList() {
		movies = new MovieList(RATING_BY_THUMB);
	}
	...
	@Test public void addARating() throws MovieListException {
		...
		movies.setRating("Goldfinger", -2);
		assertEquals("Couldn't add a rating",
				"Two thumbs down", movies.getRating("Goldfinger"));
	}
	...
	public void nonexistentThumb() throws MovieListException {
	...
	public void ratingTooLow() throws MovieListException {
		...
		movies.setRating("Plan Nine From Outer Space", -3);
	}
